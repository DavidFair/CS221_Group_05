...
/**
 * @author David Provides a wrapper for common window functions such as creating
 *         and destroying the login window
 * 
 */
public class LoginWindow {
   ...
   /**
    * This method creates a new login window and sets it to visible
    */
