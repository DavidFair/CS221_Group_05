...
public TaskList getTaskList() {
   ...
   /**
    * This method replaces the TaskList held by the MainWindow object with a new
    * TaskList.
    * 
    * @param list
    *           A new TaskList to replace the TaskList held by the MainWindow
    *           Object.
    */
   ...
   /**
    * This method replaces the MemberList held by the MainWindow object with a
    * new MemberList.
    * 
    * @param list
    *           A new MemberList to replace the MemberList held by the
    *           MainWindow Object
    */
    ...
    *            if the number of Members stored in the Members Save File cannot
    *            be read. This is usually because the file was somehow
    *            corrupted.
    * @throws IOException
    *            if the Members Save File cannot be found.
    */
   ...
   /**
    * Reads the saved connection settings from the Database Configuration file
    * and attempts to connect to the Database using those settings.
    * 
    * @param dbFile
    *           The filepath of the Database Configuration file.
    * 
    * @throws IOException
    *            if the Database Configuration file cannot be found.
    * 
    * @see callConnectOnDb
    */
    ...
    * 
    * @param url
    *           The URL of the database that TaskerCLI is attempting to connect
    *           to.
    * @param dbPort
    *           The Port Number being used to connect to the Database.
    * @param dbUsername
    *           The Username for the database that TaskerCLI is attempting to
    *           connect to.
    * @param dbPassword
    *           The Password for the database that TaskerCLI is attempting to
    *           connect to.
    * @param dbName
    *           The name of the Database that TaskerCLI is attempting to connect
    *           to.
    * 
    * @see readConfigToDb
    */
   ...
   /**
    * Checks if the GUI Window for the MainWindow exists. This enables creation
    * of multiple MainWindow Objects without spawning multiple GUI Windows.
    * 
   ...
   /**
    * Sets the value of the Connection Status indicator label in the Main Window
    * GUI
    * 
    * @param connStatus
    ...
    * 
    * @param timerState
    *           The Boolean state of the auto-sync timer.
    */
    ...
    * 
    * @param main
    *           The MainWindow Object to link with the Database Object.
    */
   ...
   /**
    * Creates a Main Window GUI Window. This method also downloads Tasks from
    * the Database or, failing that, loads a previous version of the TaskList
   ...
   public void createWindow() {
      ...
      try {
         ...
         this.displayError("Error loading member list, you need to connect to the database", "Error Loading members");
   ...
   /**
    * Ensures the connection to the Database is closed. Called at each exit
    * point of TaskerCLI to avoid dangling connections on the server side.
    */
    ...
    * 
    * @param updatedTask
    *           The Task to update on the Database.
    */
    ...
    * @param errorType
    *           The title of the error dialogue pop-up.
    */
   ...
   /**
    * Loads the Tasks from the local save file into the TaskList held by this
    * MainWindow Object.
    * 
    * @param filename
    *           The filename of the Tasks Save File.
    * 
    * @throws Exception
    *            if the Tasks Save File cannot be found or is corrupted.
    */
   ...
   /**
    * Saves all Tasks from the TaskList held by this MainWindow Object to the
    * local Tasks save file.
    * 
    * @param filename
    *           The filename of the local Tasks save file.
    * 
    * @throws IOException
    *            if the local Tasks save file cannot be found.
    */
   ...
   /**
    * Reads in Tasks that could not be sent to the Database.
    * 
    * @see writePendingTask
    */
   ...
   /**
    * Writes tasks that cannot be sent to the Database to a 'Pending Tasks' file
    * for them to be sent to the Database at a later time.
    * 
    * @param pendingTask
    *           The Task that could not be sent to the Database.
    * 
    * @throws IOException
    *            if the 'Pending Tasks' file cannot be found.
    */
   public void writePendingTask(Task pendingTask) {
      try {
         ...
         displayError("Error - Could not write pending tasks to local file", "Error storing pending tasks");
      }
   }
   ...
   /**
    * Returns Description-Comment pairs for the Elements associated with a
    * single Task.
    * 
    * @param tableIndex
    *           The position of the Task in the Table in the MainWindow GUI.
    *           This is also the index of Task in the TaskList of this
    *           MainWindow Object.
    * 
    * @return Returns an ArrayList of Description-Comment Pairs for all of the
    *         Elements associated with a single Task.
    */
   ...
   /**
    * Returns Description-Comment pairs for the Elements associated with a
    * single Task, loaded from the local Tasks save file.
    * 
    * @param filename
    *           The filename of the local Tasks save file.
    * @param tableIndex
    *           The number of the Task in the Main Window GUI Table. This is
    *           also the ordering of the selected Task in the local Tasks save
    *           file.
    * 
    * @return An ArrayList of Description-Comment pairs for the Elements
    *         associated with a single Task, loaded from the local Tasks save
    *         file.
    * 
    * @throws IOException
    *            if the local Tasks save file is not found.
    */
   ...
   /**
    * Seperates a single Description-Comment pair so they can be added to the
    * Task as an Element.
    * 
    * @param fileLine
    *           The line from the local save file containing the Description and
    *           the Comment.
    * 
   ...
   /**
    * Once a Description-Comment pair for an Element is loaded from the file, it
    * is removed from the line so the next pair to be loaded will always start
    * at position 0.
    * 
    * @param fileLine
    *           The line from the local save file containing the unseperated
    *           Description-Comment pair(s) for an Element.
    * 
    * @return The line from the local save file with the first
    *         Description-Comment pair removed.
    */
   ...
   /**
    * Gets the unedited Element data for a single Task from the local Tasks save
    * file.
    * 
    * @param filename
    *           The filename of the local Tasks save file.
    * 
    * @return The Element Data for a single task straight from the local Tasks
    *         save file.
    * 
    * @throws NumberFormatException
    *            if the local Tasks save file has been corrupted.
    * @throws IOException
    *            if the local Tasks save file cannot be located.
    */
   ...
   /**
    * Extracts the unique identifiers for each Element in a Task from the local
    * Tasks save file.
    * 
    * @param indexes
    *           The line from the local save file that contains the unique
    *           Element identifiers.
    * 
    * @return An ArrayList of all the unique identifiers for the Elements of the
