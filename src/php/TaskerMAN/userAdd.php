<div id="addView" class="modalWindow">
    <div>
        <div class="modal">
            ...
            <form name="userAdd" id="userAdd" action="addUser.php" method="POST" onsubmit="return validateEntry()">
                <fieldset class="info_box">
                    <a href="users.php" title="Close" class="close">X</a>
                    <label for="add_email" class="titles">Email:</label>
                    <input name="add_email" id="add_email" type="email" class="addInput" maxlength="45" />
                    <br/>

                    <label for="add_firstName" class="titles">First Name:</label>
                    <input name="add_firstName" id="add_firstName" type="text" class="addInput" maxlength="15" />
                    <br/>

                    <label for="add_lastName" class="titles">Last Name:</label>
                    <input name="add_lastName" id="add_lastName" type="text" class="addInput" maxlength="15" />
